...
type ObligationPATCHRequestJSONSchema struct {
	Type           OptionalData[string] `json:"type"`
	Text           OptionalData[string] `json:"text" example:"Source code be made available when distributing the software."`
	Classification OptionalData[string] `json:"classification"`
	Modifications  OptionalData[bool]   `json:"modifications"`
	Comment        OptionalData[string] `json:"comment" example:"This is a comment."`
	Active         OptionalData[bool]   `json:"active" example:"true"`
	TextUpdatable  OptionalData[bool]   `json:"text_updatable"`
}
